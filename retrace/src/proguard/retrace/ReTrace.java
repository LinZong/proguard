...
import proguard.obfuscate.MappingFileContentProvider;
...
public class ReTrace {
    ...
    private static final String REGULAR_EXPRESSION_AT =
            ".*?\\bat\\s+" + REGULAR_EXPRESSION_CLASS_METHOD + "\\s*" + REGULAR_EXPRESSION_OPTIONAL_SOURCE_LINE_INFO + REGULAR_EXPRESSION_SOURCE_LINE;
     ...
     * Creates a new ReTrace instance with a default regular expression,
     *
     * @param contentProvider the mapping file content provider that can provide mapping file content written out by ProGuard.
     */
    public ReTrace(MappingFileContentProvider contentProvider) {
        this(REGULAR_EXPRESSION, REGULAR_EXPRESSION2, false, false, new MappingReader(contentProvider));
    }
     ...
     *                          should be verbose.
     * @param mappingFile       the mapping file written by ProGuard.
     */
    public ReTrace(String regularExpression,
                   ...
                   boolean verbose,
                   File mappingFile) {
        this(regularExpression, regularExpression2, allClassNames, verbose, new MappingReader(mappingFile));
    }
     ...
     * @param verbose           specifies whether the de-obfuscated stack trace
     *                          should be verbose.
     * @param mappingReader     the mapping reader that can load mapping file written by ProGuard.
     */
    public ReTrace(String regularExpression,
                   String regularExpression2,
                   boolean allClassNames,
    ...
    public void retrace(LineNumberReader stackTraceReader,
        ...
        this.mappingReader.pump(mapper);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                new ReTrace(regularExpression, regularExpression2, allClassNames, verbose, new MappingReader(mappingFile))
