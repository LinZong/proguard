...
public class MappingReader {
    ...
    private final MappingFileContentProvider contentProvider;


    public MappingReader(File mappingFile) {
        this(new MappingFileContentProvider.LocalFileProvider(mappingFile));
    }


    public MappingReader(MappingFileContentProvider contentProvider) {
    ...
    public void pump(MappingProcessor mappingProcessor) throws IOException {
        LineNumberReader reader =
                new LineNumberReader(this.contentProvider.getReader());
        try {
